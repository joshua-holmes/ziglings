...
pub fn main() void {
    ...
    const meal = food_loop: for (menu) |food| {
        ...
        ingredient_loop: for (food.requires, 0..) |required, required_ingredient| {
            ...
            // const found = for (wanted_ingredients) |want_it| { // -- first solution --
            //     if (required_ingredient == want_it) break true;
            // } else false;
            for (wanted_ingredients) |want_it| { // -- second solution --
            ...
            // if (!found) continue :food_loop; // -- first solution --
            continue :food_loop; // -- second solution --
        }
